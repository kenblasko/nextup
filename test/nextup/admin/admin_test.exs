defmodule Nextup.AdminTest do
  ...
  describe "users" do
    ...
    @valid_attrs %{email: "some email", image: "some image", name: "some name", provider: "some provider", token: "some token"}
    @update_attrs %{email: "some updated email", image: "some updated image", name: "some updated name", provider: "some updated provider", token: "some updated token"}
    @invalid_attrs %{email: nil, image: nil, name: nil, provider: nil, token: nil}
